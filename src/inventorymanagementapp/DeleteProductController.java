...
//Constructor
    public DeleteProductController() {
        ...
        //fxml
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("view/DeleteProduct.fxml"));
    ...
    public void launchcontroller(Stage stage, String brandSelection) throws IOException{
        ...
        this.stage.setTitle(brandSelection +" Delete Product");
        this.stage.setScene(scene);
        System.out.println("88888"+deletebrand);
        
        deletebrand.setText(brandSelection);
        this.stage.setResizable(false);
        prodCombo.getItems().removeAll(prodCombo.getItems());
        
        System.out.println("inside display list");
        mediator = new Mediator();
        System.out.println("[[[[[[[[["+deletebrand.getText());
        prodMap= mediator.getProdMap(deletebrand.getText());
    ...
    public void handleDelete(ActionEvent event) throws Exception
    {
        ...
        if (btnText.equalsIgnoreCase("Delete Product")) { 
         String result= mediator.performDeleteFunction(deletebrand.getText(),prodId);
         msg.setText(result);
        }
        else if (btnText.equalsIgnoreCase("Back"))
        {
            ...
            menuController.launchcontroller(stg, deletebrand.getText());
        }
    }
